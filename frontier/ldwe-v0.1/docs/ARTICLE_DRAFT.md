...
**Human technical author:** to be confirmed before external submission  
**Engineering and editorial assistance:** OpenAI GPT-5.6 Thinking  
**Project:** World 2.0 / LEGION
...
The C11 kernel has no third-party dependencies and performs no dynamic allocation. The Rust implementation mirrors the model and adds the Windows monitor and TCP transport. Lens Studio receives `legion.pose/0.1` frames and applies the values to the dragon skeleton.
