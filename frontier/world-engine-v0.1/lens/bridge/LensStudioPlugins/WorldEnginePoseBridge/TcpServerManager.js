...
export default class TcpServerManager {
    constructor() {
        ...
        this.connections.push(this.server.onConnect.connect((socket) => {
            ...
            if (this.enableLogging) {
                console.log(`[WorldEngine Bridge] client ${socket.remoteAddress.address}:${socket.remoteAddress.port}`);
            }
    ...
    start(address, port) {
        ...
        console.log(`[WorldEngine Bridge] TCP listening on ${address}:${port}`);
    }
